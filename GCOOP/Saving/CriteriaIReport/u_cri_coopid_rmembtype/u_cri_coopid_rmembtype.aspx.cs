...
{
    public partial class u_cri_coopid_rmembtype : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_smembtype = dsMain.DATA[0].start_membtype;
            string as_emembtype = dsMain.DATA[0].end_membtype   ;
            //string as_sempno = dsMain.DATA[0].end;
