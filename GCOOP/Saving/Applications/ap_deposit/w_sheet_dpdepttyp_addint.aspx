...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function OnDwHeadItemChanged(sender, rowNumber, columnName, newValue){            
        ...
        if(columnName == "depttype_group" || columnName == "date_teffect"){
            ...
            var dateEffect = "";
            try{
                dateEffect = objDwHead.GetItem(rowNumber,"date_teffect");
                if(dateEffect == null) throw "";
            }catch(Err){ dateEffect = ""; }
            
            if(deptType != "" && dateEffect != ""){
                    postRate();
            }
        }
