    ...
    public partial class ws_sl_slip_pay : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            else if (eventArg == PostPrint)
            {
                ...
                if (rslip != "")
                {
                    if (state.SsCoopControl == "")
                    {
                        Printing.PrintSlipSlInOutIreportExat(this, rslip, state.SsCoopControl);
                    }
                    else
                    {
        ...
        public void SaveWebSheet()
        {
            try
            {
                ...
                if (print == 1)
                {
                    ...
                    {
                        if (state.SsCoopControl == "022001") //cherry ---> print exat
                        {
                            String PayinslipNo = strslip.payinslip_no.Trim();
                            Printing.RePrintSlipSlInIreportExat(this, PayinslipNo, state.SsCoopControl);
                        }
                        else
                        {
