...
namespace Saving.Applications.shrlon.ws_sl_contract_adjust_ctrl
{
    public partial class ws_sl_contract_adjust : PageWebSheet, WebSheet
    {
        ...
        public void CheckJsPostBack(string eventArg)
        {
            ...
            {
                decimal period_payment = dsPayment.DATA[0].PERIOD_PAYMENT;
                //decimal period_payment_max = dsPayment.DATA[0].PERIOD_PAYMENT_MAX;
                //if (period_payment > period_payment_max)
                //{
                //    LtServerMessage.Text = WebUtil.WarningMessage("ยอด ชำระ/งวด มากกว่ายอดสูงสุดที่สามารถชำระได้ กรุณาตรวจสอบ");
                //}
            }
        }
