    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="fixpayintovernxt_type0" runat="server">
                        <asp:ListItem Value="1">คงต้นของเดือนนั้นไว้</asp:ListItem>
                        <asp:ListItem Value="2">ลดต้นของเดือนนั้นลง</asp:ListItem>
                    </asp:DropDownList>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="dayinyear_1" runat="server" Style="text-align: center;"></asp:TextBox>
                </td>
                <td colspan="2">
                    <div>
                        <span>กรณีลดต้นแล้วติดลบ:</span></div>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="fixpayintovernxtprn_type0" runat="server">
                        <asp:ListItem Value="0" Text=""></asp:ListItem>
                        <asp:ListItem Value="1">ปรับต้นเป็นศูนย์</asp:ListItem>
                        <asp:ListItem Value="2">กลับยอดติดลบให้เป็นบวก</asp:ListItem>
                    </asp:DropDownList>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="fixpaycal_type0" runat="server">
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:TextBox ID="intdateinc_firstrcv_1" runat="server" Style="text-align: center;"></asp:TextBox>
                </td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="intdateinc_lastpay_1" runat="server" Style="text-align: center;"></asp:TextBox>
                </td>
                <td colspan="2">
                    <div>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="calint_future0" runat="server">
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:DropDownList ID="kpprocmrt_type0" runat="server">
